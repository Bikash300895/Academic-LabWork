...
void Init()
{
	...
	pix[1].readBMPFile("C:\\Users\\softeng\\Desktop\\lab4_4208 texturing\\texturing with image 2\\teapot.bmp");
	pix[1].setTexture(2);

	pix[2].readBMPFile("C:\\Users\\softeng\\Desktop\\lab4_4208 texturing\\texturing with image 2\\jack.bmp");
	pix[2].setTexture(3);

	pix[3].readBMPFile("C:\\Users\\softeng\\Desktop\\lab4_4208 texturing\\texturing with image 2\\table.bmp");
	pix[3].setTexture(4);

    pix[4].readBMPFile("C:\\Users\\softeng\\Desktop\\lab4_4208 texturing\\texturing with image 2\\cone.bmp");
	pix[4].setTexture(5);
